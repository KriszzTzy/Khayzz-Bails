...
[![GitHub stars](https://img.shields.io/github/stars/KriszzTzy/Khayzz-Bails?style=for-the-badge&color=yellow)](https://github.com/KriszzTzy/Khayzz-Bails/stargazers)
...
```bash
npm install @KriszzTzy/Khayzz-Bails
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add @KriszzTzy/Khayzz-Bails@latest
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@KriszzTzy/Khayzz-Bails")
```
...
```javascript
const makeWASocket = require("@KriszzTzy/Khayzz-Bails").default;
const { useMultiFileAuthState } = require("@KriszzTzy/Khayzz-Bails");
...
```javascript
const makeWASocket = require("@KriszzTzy/Khayzz-Bails").default;
const { DisconnectReason, useMultiFileAuthState } = require("@KriszzTzy/Khayzz-Bails");
...
```javascript
const makeWASocket = require("@KriszzTzy/Khayzz-Bails").default;
const { makeInMemoryStore } = require("@KriszzTzy/Khayzz-Bails");
...
productMessage: {
title: "TITLE!",
description: "this description for product",
thumbnail: { url: url },
productId: "PROD001",
retailerId: "RETAIL001",
url: "https://github.com/KriszzTzy/Khayzz-Bails",
body: "BODY",
footer: "© Khayzz Dev",
priceAmount1000: 777,
currencyCode: "IDR",
...
#### New Buttons interactiveMessage
```javascript
    ...
    interactiveMessage: {
      header: {
        documentMessage: {
          ...
          jpegThumbnail: fs.readFileSync(`./example.jpg`)
        },
        hasMediaAttachment: true
      },
      body: { text: "Hello World!" },
      footer: { text: "© Khayzz Dev" },
      nativeFlowMessage: {
      buttons: [
        {
          name: "single_select",
        ...
        },
        {
          name: "cta_url",
          buttonParamsJson: JSON.stringify({
            display_text: "Contact to help",
            url: `https://wa.me/628xxzz?text=Hello`,
            merchant_url: "https://kriszzyy.xyz"
          })
        }
      ],
      messageParamsJson: JSON.stringify({
        ...
        bottom_sheet: {
          ...
          list_title: "Nanao WhatsApp Bot",
          button_title: "Select"
        },
        tap_target_configuration: {
          title: "▸ X ◂",
          description: "bomboclard",
          canonical_url: "https://kriszzyy.xyz",
...
const { downloadMediaMessage, getContentType } = require("@KriszzTzy/Khayzz-Bails");
...
> [!NOTE]
> Also, this repo is now licenced under GPL 3 since it uses [libsignal-node](https://git.questbook.io/backend/service-coderunner/-/merge_requests/1) and is available at [GitHub](https://github.com/KriszzTzy).

---

**Need help with this modified version? Contact Khayz at @kriszzyy**